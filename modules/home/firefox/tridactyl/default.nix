{
  ...
  backpacker.tridactyl = {
    ...
    settings = {
      ...
      set = {
        modeindicator = false;
        # editorcmd = '' ${pkgs.backpacker.popup-term}/bin/popup-term "nvim -f %f -c 'set noruler | set laststatus=0 | set noshowcmd | set cmdheight=1 | nnoremap <ENTER> :x<ENTER> | nnoremap <ESC><ESC> :q| nnoremap <C-s> :xa| inoremap <C-s> <C-o>:x<CR>'"'';
